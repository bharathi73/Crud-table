		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtechmcrudtable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtechmcrudtable-display": {
								"semanticObject": "comtechmcrudtable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.techm.crudtable",
									"url": sap.ui.require.toUrl("com/techm/crudtable")
								}
							}
						}
					}
